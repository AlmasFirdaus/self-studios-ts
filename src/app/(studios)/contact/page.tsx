...
const Page = () => {
  ...
  return (
    <section className='mt-14 flex flex-col gap-10 md:gap-16'>
      <div className='flex flex-col justify-center items-center'>
        <h1 className='font-semibold md:font-bold text-3xl md:text-5xl/relaxed my-2 '>Contact Us</h1>
      ...
      <div className='w-full flex flex-col md:flex-row'>
        <div className='w-full md:w-1/2 aspect-video md:aspect-square relative'>
          <Image src={'/images/girls.jpg'} alt={'girls'} sizes='100%,100%' className='aspect-video md:aspect-square object-cover grayscale' fill priority />
        </div>

        <div className='w-full md:w-1/2 bg-gray-100 py-10 md:py-14 text-base/relaxed flex justify-center items-center'>
          <div className='mx-10'>
            <div className='flex justify-evenly my-8'>
              {contacts.map((contact) => (
                <div className='w-full flex flex-col gap-3 text-base/relaxed' key={contact.title}>
                  <p className='order-last md:order-none'>{contact.address}</p>
                  <div className='flex flex-col md:flex-row gap-3 md:gap-10'>
                    <p className='order-first md:order-none'>{contact.email}</p>
      ...
      <div className='w-full min-h-56 px-10 bg-gray-100 flex flex-col md:flex-row justify-evenly items-start md:items-center'>
        <h3 className='font-semibold mt-14 md:mt-0 text-2xl/relaxed md:text-4xl/relaxed'>Opening Hours</h3>
        <div className='grid grid-cols-1 gap-y-8 gap-x-4 my-10 md:my-0 leading-relaxed'>
          <div className='w-full flex flex-col md:flex-row md:justify-between md:items-center md:gap-x-12'>
            <p>Mon - Fri</p>
            <p>9.00 am - 8.00 pm</p>
          </div>
          <div className='w-full flex flex-col md:flex-row md:justify-between md:items-center md:gap-x-12'>
